...
if (file_exists(levelname)){
	...
	if(buffer_get_size(file_buffer) != 0){
		...
		instance_create(384, 224, obj_player);
		instance_create(336, 272, obj_block);
		instance_create(352, 272, obj_block);
		instance_create(368, 272, obj_block);
		instance_create(384, 272, obj_block);
		instance_create(400, 272, obj_block);
		instance_create(416, 272, obj_block);
		instance_create(432, 272, obj_block);
		instance_create(416, 256, obj_final_door);
		instance_create(352, 240, obj_switch);
		room_width = 768;
		room_height = 496;
	}
